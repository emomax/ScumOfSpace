package objects
{
	...
	public class SuperScreecher extends Ship implements ENEMY, PrimaryWeapon
	{
		...
		public function SuperScreecher(s:Sprite)
		{
				...
				if (canDoAction) {
					...
					switch (attackState) {
						...
						case "shootTriple": 
							...
							break;
						default: 
							throw new Error("Unknown move for boss SuperScreecher: " + attackState);
					}
				}
				else { /*  candonothing */}
		...
		private function getAttackState() : String {
			switch (VARS.currProgress) {
				...
				case 8:
					...
					break;
				default:
					throw new Error("Unhandled VARS.currProgress from SuperScreecher: " + VARS.currProgress);
			}
		}
